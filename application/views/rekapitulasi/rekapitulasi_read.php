                ...
                <div class="card">
                    ...
                    <div class="body table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>Nama</td>
                                <td><?php echo humanize($first_name); ?> <?php echo humanize($last_name); ?></td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                            ...
                            <tr>
                                ...
                                <td><?php echo $tempat_lahir; ?>, <?php echo indonesian_date($tanggal_lahir); ?></td>
                            </tr>
                            <tr>
                                <td>Alamat</td>
                            ...
                            <tr>
                                <td></td>
                                <td><a href="<?php echo site_url('rekapitulasi'); ?>" class="btn btn-flat btn-default">Kembali</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
